...
//           09/09/2018 Stéphane CHARGUI : Adaptation au projet V2.2
// **********************************************************************************

#include "pilotes.h"

#if (NB_FILS_PILOTES==8)
  int SortiesFP[NB_FILS_PILOTES*2] = { FP1,FP2,FP3,FP4,FP5,FP6,FP7,FP8 };
#elif (NB_FILS_PILOTES==7)
...
int etatrelais =0; //rajout stef
int fnctRelais = 0; //rajout stef
